...
export default function About() {
    return (
        <div className="bg-[#0C0E1C] text-white flex flex-col justify-around py-5" id="about">
            <div className="md:relative text-center py-5">
            ...
            <div className="flex flex-col space-y-4 md:flex-row md:space-x-7 justify-between px-5 pt-10 pb-4">
                <div className="md:w-[60%] space-y-6 lg:pl-6 md:px-5">
                    <h1 className="text-xl font-bold md:text-3xl">
                        I&apos;m <span className="text-[#E59500]">Ruchita Senjaliya,</span>{" "}
                        a Web Developer
                    </h1>
                    <p className="">
                ...
                <div className="w-full md:w-[30%]">
                    ...
                    <a href={resume} download="Resume">
                        <button className="mb-5 block mt-6 rounded-full px-7 py-3 duration-300 text-lg bg-[#E59500] text-white hover:bg-transparent border-2 hover:text-[#E59500] border-[#E59500]">
                            Download CV
                        </button>
                    </a>
                </div>
